...
def main():
	FILEPATH = "/home/aiden/ros2_ws/src/unmanned_systems_ros2_pkg/unmanned_systems_ros2_pkg/log/"
	...
	while rclpy.ok():
		...
		myData = [now, odom_node.current_position[0], odom_node.current_position[1],
			odom_node.orientation_euler[2],odom_node.orientation_euler[1],odom_node.orientation_euler[0]]
