...
def main()->None:
    ...
    while rclpy.ok():
        ...
        if (time_diff <= time_duration1):
            turtlebot_node.move_turtle(cmd_vel, 0.0)
        elif (time_diff <= time_duration1 + time_duration2):
            turtlebot_node.move_turtle(stop_vel, -ang_vel)
        elif (time_diff <= time_duration1 + time_duration2 + time_duration3):
            turtlebot_node.move_turtle(cmd_vel, 0.0)
        else:
